...
impl Surface {
    ...
    pub fn new(sizemultiplier: usize) -> Surface {
    ...
    pub fn from_file(name: &str) -> Surface{
    ...
    pub fn write_to_image_file(&self, name: &str){
    ...
    // generate a Fractal terrain with H-value of the line-segments. CAREFUL: The higher h becomes, the less fractal dimension. Range in [0;1]
    pub fn generate(&mut self, h:f64) {
        ...
        for _iteration in 0..self.sizemultiplier{
            square_step(&mut self.surface,grid_split, l, h);
            diamond_step(&mut self.surface, grid_split, l, h);
            l = (l / 2) as usize;
            grid_split *= 2;
        }
    ...
    pub fn thermal_erosion(&mut self, talus_angle:usize, erosion_factor: f64) -> (){
    ...
    */
    pub fn fractal_dim(&self, start_coeff: usize, to: usize) -> f64{
    ...
    pub fn hydraulic_erosion(&mut self, iterations: usize, inertia:f32, erosion_radius:usize){
        ...
        let mut drop =  Droplet{
            ...
            water: 1.0,
            sediment: 0.0,
            inertia, // high value = old dir taken into account more. range 0..1, std: 0.3
            pminslope: 0.01,
            sCF: 2.0,
            erosion_radius, // standard 2
